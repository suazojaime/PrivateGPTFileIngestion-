...
def main(appConfig=None):
    ...
    optionDefns = []
    argumentsStr = "manifestFile resultFile [differencesFile]"
    ...
    if len(args) > 1:
        resultsFile = args[1]
    differencesFile=None
    if len(args) > 2:
        differencesFile = args[2]
    ...
    checkBuildManifest(manifestFile, skipPatternsFile, resultsFile, differencesFile)
    minestar.exit()
