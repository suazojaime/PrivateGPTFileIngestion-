...
class SegmentIds(object):
    ...
    _string_to_id = {
        'Miscellaneous': MISC,
        'Machine Idle': IDLE,
        'Key On - Engine Off': KEY_ON_ENGINE_OFF,
        'Key Off - Engine On': KEY_OFF_ENGINE_ON,
        'Key Off - Engine Off': KEY_OFF_ENGINE_OFF,
        'Dig': DIG,
        'Travel Loaded': TRAVEL_LOADED,
        'Dump': DUMP,
        'Partial Dump': PARTIAL_DUMP,
        'Travel Empty': TRAVEL_EMPTY,
        'Backdrag': BACKDRAG
    }
